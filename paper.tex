...
\phi(\flow) = \tuple{\vec{t},\vec{s},\vec{d},\vec{a},\vec{b},\vec{z},\vec{v}},
\end{align}
...
% Many common traffic modeling assumptions can be expressed succinctly and precisely in terms of transformations or conditions on this behavior matrix and its components.

Before continuing on to less mundane topics, we must briefly address our choices of constants appearing in \Table{quantization}.
