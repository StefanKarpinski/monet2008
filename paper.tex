...
While Harpoon may be sufficiently realistic for the intended purpose of generating Internet backbone traffic,\harpoonnote
for the purpose of generating local-area traffic for wireless experiments, it is not sufficiently realistic.
...
\begin{sidewaysfigure*}
{\includegraphics[height=6.25in]{plots/basic_behaviors_1.pdf}}\hfill%
{\includegraphics[height=6.25in]{plots/basic_behaviors_2.pdf}}
\caption{Basic behaviors.}
