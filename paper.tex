...
On the other hand, we have discredited both uniform and marginal modeling as viable approaches that can fully address the workload modeling requirements of the wireless research community. This, we believe, is where the General Matrix Model plays a vital role in the development of better models.  
