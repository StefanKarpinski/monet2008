...
\end{align}
\Figure{trace-vs-uniform} graphically depicts examples of uniform behaviors as compared to actual behaviors from traces.
%By replacing $S'$ with $S$, this can also be viewed as a set of linear constraints on the matrix $S$, providing a proscriptive definition 
