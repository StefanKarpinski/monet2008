...
\end{itemize}
If there are $f$ flows in the entire workload pattern, then its collective behavior can be described with six matrices:
\begin{itemize}
...
\end{itemize}
The rows of each matrix are behavior vectors of the $f$ flows in the workload, indexed in some chosen order.
