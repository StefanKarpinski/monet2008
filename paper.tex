...
In \Section{traffic-generation} we will describe how to generate a flow for any sum of representation vectors.
...
While it is by no means the only possible representation of traffic in terms of matrices, as demonstrate in the following sections, many common traffic modeling assumptions can be expressed succinctly and precisely in terms of transformations or conditions of the \caps{GMM} and its components.
