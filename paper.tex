...
The node-conditional models tend to err in the same direction as the \model{full marginal} model, but in a few cases where the aspects of marginality lead to errors in different directions, the outcome follows one of the aspects more than others.
...
% TODO: rerun the mixed model simulations.
