...
\newcommand{\thetitle}{LAN Workload: The Failure of Uniform Modeling}
...
\newcommand{\Section}[1]{\S\ref{sec:#1}}
...
\\\hline
\end{tabular}
\caption{Summary of classes and their attributes in the proposed Traffic Object Model ({\footnotesize{TOM}}) for {\footnotesize{WLAN}} workload generation.}
\vspace{-2em}
\end{table}
