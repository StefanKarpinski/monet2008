...
The field of realistic workload generation, however, remains an active area of research with many unanswered questions.
...
Because of the lack of adequate techniques for modeling this complex multilevel interdependence, three fundamental types of simplifying assumptions are commonly applied to both the analysis and generation of traffic:
\begin{enumerate}
\item \textbf{Uniformity:} that certain aspects of traffic behavior are uniformly distributed. For example, that  all nodes in a network have equal probability of being the source or destination of traffic.
