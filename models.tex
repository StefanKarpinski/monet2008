...
\begin{minipage}[l]{4.3in}
\vspace{2pt}
\raisebox{1.5pt}{$\centerdot$} start time relative to previous flow sampled from fitted Lognormal model\raisebox{1.5pt}{\scriptsize*} \\
\raisebox{1.5pt}{$\centerdot$} flow size sampled from fitted BiPareto model\raisebox{1.5pt}{\scriptsize*} \\
\raisebox{1.5pt}{$\centerdot$} inherits distributions of size/interval packet behaviors from destination node \\
\raisebox{1.5pt}{$\centerdot$} generic packets generated until flow size exhausted
\vspace{2pt}
\end{minipage} \\
